  ...
  if(!selJob){
    return <div>
      ...
      <div style={{textAlign:"center",padding:"24px 0 32px"}}>
        <img src="/tgb-logo.svg" alt="Tall Guy Builds" style={{width:72,height:72,borderRadius:14,objectFit:"contain",marginBottom:14,boxShadow:"0 4px 20px #00000050"}}/>
  ...
  return <div style={{background:C.bg,minHeight:"100vh",display:"flex",alignItems:"center",justifyContent:"center",fontFamily:fb,padding:20}}>
    <div style={{width:"100%",maxWidth:380}}>
      <div style={{textAlign:"center",marginBottom:32}}>
        <img src="/tgb-logo.svg" alt="TGB" style={{width:64,height:64,borderRadius:12,objectFit:"contain",marginBottom:16,boxShadow:"0 4px 20px #00000060"}}/>
